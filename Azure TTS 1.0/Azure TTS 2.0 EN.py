                        ...
                        ui.VGroup(
                            [
                                ui.HGroup(
                                    {"Weight": 0.05},
                                    [
                                        ui.CheckBox({"ID": 'UseAPICheckBox', "Text": 'Using API', "Checked": True, "Weight": 0.5}),
                                        ui.CheckBox({"ID": 'UnuseAPICheckBox', "Text": 'Not Using API', "Checked": False, "Weight": 0.5}),
                                    ]
                                ),
...
def toggle_api_checkboxes(use_api_checked):
    itm["ApiKey"].Enabled = use_api_checked
    itm["Region"].Enabled = use_api_checked
    itm["StyleCombo"].Enabled = use_api_checked
    itm["MutilCombo"].Enabled = use_api_checked
    itm["PlayButton"].Enabled = use_api_checked
    itm["BreakButton"].Enabled = use_api_checked
    itm["StyleDegreeSpinBox"].Enabled = use_api_checked
    itm["StyleDegreeSlider"].Enabled = use_api_checked
    itm["OutputFormatCombo"].Enabled = use_api_checked
    print("Using API" if use_api_checked else "Not Using API")

def on_unuseapi_checkbox_clicked(ev):
    itm["UseAPICheckBox"].Checked = not itm["UnuseAPICheckBox"].Checked
    toggle_api_checkboxes(itm["UseAPICheckBox"].Checked)

win.On.UnuseAPICheckBox.Clicked = on_unuseapi_checkbox_clicked

def on_useapi_checkbox_clicked(ev):
    itm["UnuseAPICheckBox"].Checked = not itm["UseAPICheckBox"].Checked
    toggle_api_checkboxes(itm["UseAPICheckBox"].Checked)

win.On.UseAPICheckBox.Clicked = on_useapi_checkbox_clicked
...
edgeTTS_voices = {
    ...
    "it-IT-GiuseppeNeural": {"Gender": "Male"},
    ...
    "ko-KR-HyunsuNeural": {"Gender": "Male"},
    ...
    "pt-BR-ThalitaNeural": {"Gender": "Female"},
...
if saved_settings:
    itm["UnuseAPICheckBox"].Checked = saved_settings.get("UNUSE_API", default_settings["UNUSE_API"])
    itm["UseAPICheckBox"].Checked = saved_settings.get("USE_API", default_settings["USE_API"])
...
if itm["UnuseAPICheckBox"].Checked:
    itm["ApiKey"].Enabled = False
    itm["Region"].Enabled = False
    itm["StyleCombo"].Enabled = False
    itm["MutilCombo"].Enabled = False
    itm["PlayButton"].Enabled = False
    itm["BreakButton"].Enabled = False
    itm["StyleDegreeSpinBox"].Enabled = False
    itm["StyleDegreeSlider"].Enabled = False
    itm["OutputFormatCombo"].Enabled = False
...
def on_load_button_clicked(ev):
    ...
    while True:
        if itm["UnuseAPICheckBox"].Checked:
            ...
            extension = itm["OutputFormatCombo"].CurrentText.split(", ")[1]
        count += 1
        filename = itm["Path"].Text + f"/Untitled#{count}" + extension
    ...
    if stream and current_context==subtitle:
        ...
        output_format = itm["OutputFormatCombo"].CurrentText
        if itm["UnuseAPICheckBox"].Checked:
            if voice_name not in edgeTTS_voices:
                show_warning_message('Selected voice is not supported by edgeTTS.')
                return
...
def on_reset_button_clicked(ev):
    ...
    #itm["UnuseAPICheckBox"].Checked = default_settings["UNUSE_API"]
    #itm["UseAPICheckBox"].Checked = default_settings["USE_API"]
...
def close_and_save(settings_file):
    settings = {
        ...
        "UNUSE_API":itm["UnuseAPICheckBox"].Checked,
        "USE_API":itm["UseAPICheckBox"].Checked,
    }
