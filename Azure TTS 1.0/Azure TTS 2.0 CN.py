                        ...
                        ui.VGroup(
                            [
                                 ...
                                 ui.HGroup(
                                    {"Weight": 0.05},
                                    [
                                        ui.CheckBox({"ID": 'UseAPICheckBox', "Text": '使用 API', "Checked": True, "Weight": 0.5}),
                                        ui.CheckBox({"ID": 'UnuseAPICheckBox', "Text": '不使用 API', "Checked": False, "Weight": 0.5}),
                                    ]
                                ),
                                ui.HGroup(
                                    {"Weight": 0.05},
...
def toggle_api_checkboxes(use_api_checked):
    ...
    itm["MultilingualCombo"].Enabled = use_api_checked
    ...
    if stream and current_context==subtitle:
        ...
        if itm["UnuseAPICheckBox"].Checked:
            if voice_name not in edgeTTS_voices:
                show_warning_message('该语音仅在使用API时可用！')
                return
